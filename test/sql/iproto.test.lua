...
cn = remote.connect(box.cfg.listen)
future1 = cn:execute('insert into test values (1, 1)', nil, nil, {is_async = true})
future2 = cn:execute('insert into test values (null, 2)', nil, nil, {is_async = true})
future3 = cn:execute('insert into test values (null, 2), (null, 3)', nil, nil, {is_async = true})
future4 = cn:execute('insert into test values (17, 2)', nil, nil, {is_async = true})
future5 = cn:execute('insert into test values (null, 2), (null, 3)', nil, nil, {is_async = true})
future1:wait_result()
future2:wait_result()
future3:wait_result()
future4:wait_result()
future5:wait_result()
future6 = cn:execute('select * from test', nil, nil, {is_async = true})
future6:wait_result()
